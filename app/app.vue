...
const title = 'Alpha Portal CMS - Multi Tenant Company Portal Platform'

const description =
  'Enterprise multi-tenant company portal platform built with Nuxt, Django, PostgreSQL, and Tailwind CSS.\
  Manage news, projects, careers, GIS, documents, ESG content, and digital mining operations in one centralized workspace.'
