...
type ColumnActions = {
  onEdit: (row: ProjectSectionRow) => void
  onDelete: (row: ProjectSectionRow) => void
}
...
export function getProjectSectionColumns(
  actions: ColumnActions,
  opts: ColumnOptions = {}
): ColumnDef<ProjectSectionRow>[] {
      ...
      ? [
          {
            ...
            cell: ({ row }: { row: { original: ProjectSectionRow } }) =>
          ...
          } as ColumnDef<ProjectSectionRow>,
        ]
      : []),
  ]
}