...
const emit = defineEmits<{
  ...
  (e: "submit", payload: NewsCategoryPayload): void
}>()

const canMutate = computed(() => props.role !== "GLOBAL_VIEWER")

const title = computed(() =>
  props.mode === "create" ? "Add News Category" : "Edit News Category"
)

const local = ref<NewsCategoryFormState>({
  id: undefined,
  name: "",
  slug: "",
})
...
function submit() {
  const payload: NewsCategoryPayload = {
    ...
    slug: local.value.slug.trim() || null,
  }
